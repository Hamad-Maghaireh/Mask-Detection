...
st.title("Mask detection model",anchor=False)
st.subheader("Using YOLOv8",anchor=False)
...
def annotate_image(image, results):
    for box in results[0].boxes:  # Extract bounding boxes from the results
        ...
        #if you want to show conf level add to the labebl {conf:.2f}
